...
class ExtendedJob(TimeStampedModel):
    ...
    bachelor_required = models.BooleanField(default=None, null=True, blank=True)
    master_required = models.BooleanField(default=None, null=True, blank=True)
    phd_required = models.BooleanField(default=None, null=True, blank=True)
    ...
    us_only = models.BooleanField(default=None, null=True, blank=True)
    salary = models.CharField(max_length=255, default=None, null=True, blank=True)
    employment_type = models.CharField(max_length=255, default=None, null=True, blank=True)
    medical_insurance = models.BooleanField(default=None, null=True, blank=True)
    ...
    job_category = models.CharField(max_length=255, default=None, null=True, blank=True)
